<template>
    <div>
        <el-card style="margin:15px">
            ...
            <el-table v-loading="loading" :data="tableData" stripe size="middle"
                style="width: 100%;margin-top:8px;height:600px">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button type="primary" size="mini" @click="btnPermission(scope.row.id)">分配权限</el-button>
            ...
            <!-- 添加角色dialog -->
            <el-dialog title="添加角色" :visible.sync="dialogVisible" width="35%" @close="btnCancle">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="启用:">
                        ...
                        <el-switch v-model="ruleForm.state" size="mini" :active-value="1" :inactive-value="0">
                        </el-switch>
            ...
            <el-dialog title="分配权限" :visible="showPermissionDialog" @close="btnPermCancel">
                ...
                <el-tree ref="permTree" check-strictly node-key="id" :data="permissionData" :props="{ label: 'name' }"
                    show-checkbox default-expand-all :default-checked-keys="permIds" />
                <!-- 确定和取消按钮 -->
            ...
            <!-- 分页 -->
            <el-pagination layout="prev, pager, next" :page-size="page.pagesize" :current-page="page.page"
